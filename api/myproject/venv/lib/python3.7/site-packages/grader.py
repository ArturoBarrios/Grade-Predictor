...
def get_grades(): 
    ...
    while i<num_of_files:
        ...
        grade = prediction.predictSong(file, files_to_use[0],files_to_use[1], files_to_use[2], files_to_use[3])
...
def getFileNames(index):
    res = None
    if(index=="ABRSM(1-8)"):
        res = ["models/abrsm_all_1.sav", "data/abrsm_all_1.csv", 100,9]
    elif(index=="Piano Marvel(0-10)"):
        res = ["models/piano_marvel_all_2000_1.sav", "data/piano_marvel_all_2000_1.csv", 500,9]
    else:
        res = ["models/abrsm_all_1.sav", "data/abrsm_all_1.csv", 100,9]
